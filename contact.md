...
> Écrire à la rédaction de Meilleurs. : droit de réponse d'un établissement, signalement d'erreur, candidature, demande presse. Réponse sous 48 h ouvrées.

Source : https://www.lesmeilleursrestaurants.fr/contact.html
...
Droit de réponse · erreur à signaler · candidature · presse, réponse sous 48 h ouvrées
...
- Signalement d'erreur : un prix, une adresse, un jour de fermeture, un nom mal orthographié.

- Candidature à la rédaction, avec deux textes déjà écrits plutôt qu'un curriculum.
...
Un droit de réponse est traité en priorité, et publié sur la page
...
Choisir un motif
Droit de réponse d'un établissement
...
J'accepte que mon nom, mon e-mail et mon message soient traités
par la rédaction pour répondre à ma demande.
[Politique de confidentialité](confidentialite/)

Les champs marqués d'une étoile sont requis. Réponse sous 48 h ouvrées.

Envoyer →

Bien reçu.

Votre message est arrivé à la rédaction. Réponse sous 48 h ouvrées,
plus vite s'il s'agit d'une erreur à corriger.
